...
|---|---------|----------------------|
| TM1 | **Deadline presentazione: 26/03/2026 (non negoziabile)** | L'intero ciclo di sviluppo — dalla definizione dei requisiti al deploy in produzione — ha dovuto completarsi in **~13 settimane** (18/12/2025 → 26/03/2026). **Questo rappresenta uno dei vincoli piu pesanti dell'intero progetto**: undici settimane per progettare, sviluppare, integrare hardware, backend, frontend e firmware, documentare e preparare la presentazione finale. |
| TM2 | **Team di cinque studenti part-time** | Ciascun membro contribuisce al progetto parallelamente ad altri impegni scolastici. Il monte ore totale stimato e ~260 h, con una distribuzione asimmetrica: **60–80 h ciascuno** per i tre sviluppatori tecnici principali (Roman / Luka / Shaeek), e **20–30 h ciascuno** per i due ruoli di supporto (Matteo / De Togni). Il confronto con le 160+ h mensili di un developer full-time rende evidente la densita del lavoro concentrato in sole 13 settimane. |
